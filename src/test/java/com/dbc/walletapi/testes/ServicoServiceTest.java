...
public class ServicoServiceTest {
    ...
    @Test
    public void totalValorServicosIDdeADMINUsandoMesEAno() throws Exception{
       List<ServicoEntity> servicoEntities = new ArrayList<>();
       ...
       BigDecimal total = servicoService.listByMesEAno(2021,9,"1");
       Assertions.assertNotNull(total);
    }

    @DisplayName("Valor total em reais dos serviços por ID do gerente.")
    @Test
    public void totalValorServicosPorIdGerenteUsandoMesEAno() throws Exception{
        List<ServicoEntity> servicoEntities = new ArrayList<>();
    ...
    @Test(expected = RegraDeNegocioException.class)
    public void totalValorServicosPorIdGerenteUsandoMesEAnoSemSucesso() throws Exception{
        List<ServicoEntity> servicoEntities = new ArrayList<>();
        ServicoEntity servico = new ServicoEntity();
        UsuarioEntity usuario = new UsuarioEntity();
        GerenteEntity gerente = new GerenteEntity();
